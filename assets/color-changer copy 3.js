...
localStorage.setItem('themeModeDefault', default_mode);
...
function toggleDarkMode(isDark) {
    ...
    if (isDark) {
        ...
        localStorage.setItem('themeMode', default_mode);
    }
}
...
window.addEventListener("scroll", () => {
    ...
    // if (backToTop) backToTop.style.backgroundColor = isDark ? ha_dark_light_mode_back_to_top_color : '';
